...
export function DocumentsSection() {
  const {
    search, statusFilter, typeFilter, fraudFilter,
    setSearch, setStatusFilter, setTypeFilter, setFraudFilter, resetFilters, openDetail,
  } = useAppStore()
      ...
      <Card>
        <CardContent className="p-4">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <Select
                ...
                onValueChange={(v) => { setPage(1); setTypeFilter(v === 'ALL' ? null : v) }}
              >
              ...
              <Select
                ...
                onValueChange={(v) => { setPage(1); setStatusFilter(v === 'ALL' ? null : v) }}
              >
              ...
              <Select
                value={fraudFilter ?? 'ALL'}
                onValueChange={(v) => { setPage(1); setFraudFilter(v === 'ALL' ? null : v) }}
              >
                <SelectTrigger className="h-9 w-[140px] text-xs">
          ...
          <div className="mt-3 flex items-center gap-2 text-xs text-muted-foreground">
            ...
            {hasFilters ? (
              <span>
                Filtered: {total} of {total} documents
              </span>
            ) : (
          ...
          <CardContent className="flex flex-col items-center justify-center gap-3 py-16 text-center">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground">
                {hasFilters ? 'Try clearing filters' : 'Upload your first document to see it here'}
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          {items.map((doc) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-3">
                ...
                {doc.fraudRisk && doc.fraudRisk !== 'LOW' && (
                  <div className="mt-2">
                    <FraudRiskBadge risk={doc.fraudRisk} />
                  </div>
                )}
